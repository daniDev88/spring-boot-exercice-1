...
CREATE TABLE IF NOT EXISTS RATES.T_RATES (
...
CREATE INDEX rates_brand_id_index ON RATES.T_RATES USING btree (brand_id);
CREATE INDEX rates_product_id_index ON RATES.T_RATES USING btree (product_id);
CREATE INDEX rates_currency_code_index ON RATES.T_RATES USING btree (currency_code);

INSERT INTO RATES.t_rates
